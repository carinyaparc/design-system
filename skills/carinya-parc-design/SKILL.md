---
name: carinya-parc-design
description: Use this skill to generate well-branded interfaces and assets for Carinya Parc (a regenerative farm, Upper Hunter NSW), either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping.
user-invocable: true
---
